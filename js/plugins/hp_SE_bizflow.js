...
nhn.husky.SE_bizflow = jindo.$Class({
    ...
    _assignHTMLObjects: function(elAppContainer) {
        ...
        this.oInputButton = cssquery.getSingle(".se_button_bizflow", elAppContainer);
    },
    $ON_MSG_APP_READY: function() {
        this.oApp.exec("REGISTER_UI_EVENT", ["bizflow", "click", "SE_TOGGLE_BIZFLOW_LAYER"]);
        //input button에 click 이벤트를 할당.
        this.oApp.registerBrowserEvent(this.oInputButton, "click", "CREATE_MODELER");
    },
    ...
    $ON_CREATE_MODELER: function() {
        window.open('mxgraph/main/editors/diagrameditor.html','newModel');
